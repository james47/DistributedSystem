...
public class Skeleton<T>
{
	...
	private String status; // "stopped", "started"
	private Class<T> c;
	private T server;
	...
	public static final int DEFAULT_PORT = 14736;
    ...
    public synchronized void start() throws RMIException
    {
        if (address == null) {
            try {
                ...
                e.printStackTrace();
                throw new RMIException("failed to get localhost", e);
            }
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new RMIException("failed to create listen socket", e);
        }
        listeningThread = new Thread(new ServerThread<T>(this));
    ...
    public synchronized void stop()
    {
        if (status.equals(STATUS_STOPPED))
            return;
        try {
            // close socket to terminate listening thread
            serverSocket.close();
